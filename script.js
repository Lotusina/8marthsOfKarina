document.addEventListener("DOMContentLoaded", () => {
	...
	const text1 =
			"Желаю тебе множество чудесных дней,^500 наполненных радостными событиями, красивыми словами, любовью и душевностью.^1000 Пусть твои желания исполняются всё чаще, ,безумно хочу окружать тебя теплом и нежностью,^400 заботой и безграничным вниманием.^600 Счастья тебе и пусть оно не заканчивается! И с праздником весны прекрасным!",
		text2 =
			"Пускай красочными будут твои дни, а в жизни случаются самые настоящие и невероятные чудеса. Желаю теплой, солнечной и радостной весны, чтобы ты всегда была согрета моим ласковым словом, делом и моей любовью.",
		text3 =
			"Обожаю твою безграничную, милую улыбку, безумно верю в тебя и люблю тебя. С 8 Марта милашка!";
